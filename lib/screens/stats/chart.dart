...
BarChartGroupData makeGroupData(int x,double y){
  return BarChartGroupData(
    ...
    barRods: [
      BarChartRodData(
        ...
        width: 15,//width of the barchart rod
        backDrawRodData:BackgroundBarChartRodData(
          show: true,
          toY: 5,
        color: Color.fromARGB(120, 105, 104, 104) 
        )
      )
    ]
  );
  ...
  meta: meta,        // Correct required parameter
  space: 16,         // Optional: controls spacing between label and axis
  child: text,       // Pass the String directly (not a Text widget)
);
